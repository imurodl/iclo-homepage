...
const FeaturesSection = () => {
  ...
  const homedenFeatures = [
    {
      icon: '🤖',
      title: 'AI 셀프 구강체크',
      description: '스마트폰 카메라로 간편하게 구강 상태를 체크하고 AI가 분석합니다',
  ...
  const connectFeatures = [
    ...
    },
    {
      icon: '💬',
      title: '단골과의 소통',
      description: '질문답변, 결과전송, 진료계약, 다음진료안내, 각종 서류 온라인 발급',
      image: 'https://images.unsplash.com/photo-1649972904349-6e44c42644a7?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'
    }
  ];
      ...
      <div className="container-custom">
        ...
        <div className="mb-20">
          <div className="text-center mb-12 animate-on-scroll">
            <h3 className="text-2xl font-bold text-homeden-navy mb-2">HomeDen 기능</h3>
            <p className="text-lg text-gray-600">AI 셀프 구강체크 & 전문의 상담</p>
          </div>
            ...
            {homedenFeatures.map((feature, index) => (
              ...
              >
                ...
                <CardContent className="p-4">
                  <h4 className="font-bold text-homeden-navy mb-2">{feature.title}</h4>
        ...
        <div>
          <div className="text-center mb-12 animate-on-scroll">
            <h3 className="text-2xl font-bold text-homeden-navy mb-2">HomeDen Connect 기능</h3>
