...
const HeroSection = () => {
  ...
  const slides = [
    {
      image: "/lovable-uploads/main_banner_1.png",
      alt: "현대적인 치과 진료실",
    },
    {
      image: "/lovable-uploads/main_banner_2.png",
      alt: "치과 의사가 진료하는 모습",
    },
  ];
        ...
        {slides.map((slide, index) => (
          ...
          >
            <div
              ...
              style={{
                backgroundImage: `linear-gradient(135deg, rgba(44, 62, 80, 0.5) 0%, rgba(58, 79, 99, 0.5) 100%), url(${slide.image})`,
              }}
            />
          </div>
        ))}
